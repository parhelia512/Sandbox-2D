...
constexpr static inline std::array<BlockInfo, blockCount> blockInfo {
   ...
   /*  5 */ BlockInfo{"sand",               BlockType::solid | BlockType::sand,                                                                        0.5f,         0,            Item{}},
   /*  6 */ BlockInfo{"sandstone",          BlockType::solid,                                                                                          1.5f,         1,            Item{}},
   /*  7 */ BlockInfo{"bricks",             BlockType::solid,                                                                                          2.5f,         2,            Item{}},
   /*  8 */ BlockInfo{"glass",              BlockType::solid | BlockType::transparent,                                                                 0.25f,        0,            Item{}},
   /*  9 */ BlockInfo{"planks",             BlockType::solid,                                                                                          1.5f,         0,            Item{}},
   /* 10 */ BlockInfo{"stone_bricks",       BlockType::solid,                                                                                          3.5f,         2,            Item{}},
   /* 11 */ BlockInfo{"tiles",              BlockType::solid,                                                                                          3.5f,         2,            Item{}},
   /* 12 */ BlockInfo{"obsidian",           BlockType::solid,                                                                                          2.5f,         3,            Item{}},
   ...
   /* 20 */ BlockInfo{"honey_block",        BlockType::solid | BlockType::sticky,                                                                      1.5f,         0,            Item{}},
   /* 21 */ BlockInfo{"crispy_honey_block", BlockType::solid,                                                                                          2.0f,         0,            Item{}},
   /* 22 */ BlockInfo{"slime_block",        BlockType::solid | BlockType::bouncy | BlockType::transparent,                                             1.0f,         0,            Item{}},
   /* 23 */ BlockInfo{"bubble_block",       BlockType::transparent,                                                                                    0.25f,        0,            Item{}},
   /* 24 */ BlockInfo{"slime_platform",     BlockType::platform | BlockType::transparent | BlockType::solid | BlockType::flowable | BlockType::bouncy, 0.75f,        0,            Item{}},
   /* 25 */ BlockInfo{"cactus_block",       BlockType::solid,                                                                                          0.75f,        0,            Item{}},
   /* 26 */ BlockInfo{"coal_ore",           BlockType::solid,                                                                                          2.5f,         1,            Item{ItemType::item, 1, 1}},
   /* 27 */ BlockInfo{"iron_ore",           BlockType::solid,                                                                                          2.5f,         2,            Item{ItemType::item, 2, 1}},
   /* 28 */ BlockInfo{"gold_ore",           BlockType::solid,                                                                                          3.0f,         3,            Item{ItemType::item, 3, 1}},
